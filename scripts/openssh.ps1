...
# ensure mulesoft can log in
Write-Output "Setting mulesoft user file permissions"
New-Item -ItemType Directory -Force -Path "C:\Users\mulesoft\.ssh"
C:\Windows\System32\icacls.exe "C:\Users\mulesoft" /grant "vagrant:(OI)(CI)F"
C:\Windows\System32\icacls.exe "C:\Program Files\OpenSSH\bin" /grant "mulesoft:(OI)RX"
C:\Windows\System32\icacls.exe "C:\Program Files\OpenSSH\usr\sbin" /grant "mulesoft:(OI)RX"
